                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="customer/login">Login</a>
                                    <ul class="dropdown">
                                        <li><a href="customer/registration">Register </a></li>
                                    </ul>
                                    </li>
                            ...
                            <!--        <i class="fa fa-search" aria-hidden="true"></i>
                                ...
                                <div class="book-now-btn ml-3 ml-lg-5">
                                    <a href="customer/login">Book Now <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                            <!-- Nav End -->
                        </div>
